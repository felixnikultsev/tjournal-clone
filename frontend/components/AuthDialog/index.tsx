  ...
  return (
    <Dialog open={visible} onClose={onClose} maxWidth={'xs'} classes={{ paper: styles.authDialog }} fullWidth>
      <DialogContent>
        ...
        {formType === 'main' && (
          <>
            <div className={styles.mainMethods}>
              <Button variant={'contained'} className={'mb-15'} fullWidth>
              ...
              <Button variant={'contained'} className={'mb-15'} onClick={() => setFormType('email')} fullWidth>
